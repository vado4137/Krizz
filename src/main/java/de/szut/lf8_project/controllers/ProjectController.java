...
public class ProjectController {
    ...
    public List<GetProjectDTO> getProjectsByEmployeeId(@PathVariable Long id) {
    ...
    public GetProjectDTO addEmployeeToProject(@PathVariable Long id, @RequestBody CreateEmployeeAssocDTO dto) {
        ProjectEntity entity = projectService.findById(id);
        if (entity == null) {
            throw new ResourceNotFoundException("Project " + id + " does not exist");
        }
